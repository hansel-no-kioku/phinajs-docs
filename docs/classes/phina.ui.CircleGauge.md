...
* visualValue : Number&ensp;&ensp;(from [phina.ui.Gauge](phina.ui.Gauge.md))
* animation : Boolean&ensp;&ensp;(from [phina.ui.Gauge](phina.ui.Gauge.md))
* animationTime : Number&ensp;&ensp;(from [phina.ui.Gauge](phina.ui.Gauge.md))
* value : Number&ensp;&ensp;(from [phina.ui.Gauge](phina.ui.Gauge.md))
* maxValue : Number&ensp;&ensp;(from [phina.ui.Gauge](phina.ui.Gauge.md))
* gaugeColor : String&ensp;&ensp;(from [phina.ui.Gauge](phina.ui.Gauge.md))
* cornerRadius : Number&ensp;&ensp;(from [phina.ui.Gauge](phina.ui.Gauge.md))
