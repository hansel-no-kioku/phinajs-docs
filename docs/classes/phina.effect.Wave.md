...
* stroke : Boolean&ensp;&ensp;(from [phina.display.Shape](phina.display.Shape.md))
...
* [prerender](phina.display.CircleShape.md#instance_prerender)&ensp;&ensp;(from [phina.display.CircleShape](phina.display.CircleShape.md))
